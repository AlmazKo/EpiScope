...
final class MenuBarChartDemo {
    ...
    private static let configs: [(name: String, bars: [MenuBarChart.Bar])] = [
        ...
        ("3 · four running (one slot free)", Array(repeating: .active, count: 4)),
        ("4 · five running (all slots taken)", Array(repeating: .active, count: 5)),
        ("5 · ten running (five cut)", Array(repeating: .active, count: 10)),
